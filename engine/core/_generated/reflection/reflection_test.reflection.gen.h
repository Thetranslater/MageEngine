...
namespace TypeFieldReflectionOparator{
    ...
    public:
        ...
        static PJson writeByName(void* instance){
            return PSerializer::write(*(BaseTest*)instance);
        }
        // base class
...
#define ArraystdSSvectorLintPROperatorMACRO
    ...
    void TypeWrapperRegister_BaseTest(){
        ...
        REGISTER_FIELD_TO_MAP("BaseTest", f_field_function_tuple_m_int);
        ...
        REGISTER_FIELD_TO_MAP("BaseTest", f_field_function_tuple_m_int_vector);
        ...
        ClassFunctionTuple* f_class_function_tuple_BaseTest=new ClassFunctionTuple(
        ...
        REGISTER_BASE_CLASS_TO_MAP("BaseTest", f_class_function_tuple_BaseTest);
    }namespace TypeFieldReflectionOparator{
    ...
    public:
        ...
        static PJson writeByName(void* instance){
            return PSerializer::write(*(Test1*)instance);
        }
        // base class
        static int getTest1BaseClassReflectionInstanceList(ReflectionInstance* &out_list, void* instance){
            ...
            for (int i=0;i<count;++i){
               out_list[i] = TypeMetaDef(Mage::BaseTest,static_cast<Test1*>(instance));
            }
            return count;
        }
        // fields
    ...
    void TypeWrapperRegister_Test1(){
        FieldFunctionTuple* f_field_function_tuple_m_char=new FieldFunctionTuple(
        ...
        REGISTER_FIELD_TO_MAP("Test1", f_field_function_tuple_m_char);
        
        
        ClassFunctionTuple* f_class_function_tuple_Test1=new ClassFunctionTuple(
        ...
        REGISTER_BASE_CLASS_TO_MAP("Test1", f_class_function_tuple_Test1);
    }namespace TypeFieldReflectionOparator{
    ...
    public:
        ...
        static PJson writeByName(void* instance){
            return PSerializer::write(*(Test2*)instance);
        }
        // base class
        static int getTest2BaseClassReflectionInstanceList(ReflectionInstance* &out_list, void* instance){
            ...
            out_list = new ReflectionInstance[count];
            for (int i=0;i<count;++i){
               out_list[i] = TypeMetaDef(Mage::BaseTest,static_cast<Test2*>(instance));
            }
            return count;
        }
        // fields
...
#define ArraystdSSvectorLReflectionSSReflectionPtrLBaseTestRROperatorMACRO
    ...
    void TypeWrapperRegister_Test2(){
        FieldFunctionTuple* f_field_function_tuple_m_test_base_array=new FieldFunctionTuple(
        ...
        REGISTER_FIELD_TO_MAP("Test2", f_field_function_tuple_m_test_base_array);
        
        ArrayFunctionTuple* f_array_tuple_stdSSvectorLReflectionSSReflectionPtrLBaseTestRR = new  ArrayFunctionTuple(
        ...
        REGISTER_ARRAY_TO_MAP("std::vector<Reflection::ReflectionPtr<BaseTest>>", f_array_tuple_stdSSvectorLReflectionSSReflectionPtrLBaseTestRR);
        ClassFunctionTuple* f_class_function_tuple_Test2=new ClassFunctionTuple(
        ...
        REGISTER_BASE_CLASS_TO_MAP("Test2", f_class_function_tuple_Test2);
    }
namespace TypeWrappersRegister{
        void BaseTest(){ TypeWrapperRegister_BaseTest();}
        void Test1(){ TypeWrapperRegister_Test1();}
        void Test2(){ TypeWrapperRegister_Test2();}
}//namespace TypeWrappersRegister
