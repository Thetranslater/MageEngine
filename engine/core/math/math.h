...
namespace Mage {
	...
	public:
		...
		static float Exp(float power) { return std::expf(power); }
		static float Floor(float value) { return std::floorf(value); }
		static int   FloorToInt(float value) { return int(std::floorf(value)); }
		...
		static float Round(float value) { return std::rint(value); }
		static int   RoundToInt(float value) { return int(std::rint(value)); }
		static float Sign(float value) { return value < 0.f ? -1.f : 1.f; }
		static float Sin(float value) { return std::sin(value); }										   //use in radians
		static float Sqrt(float value) { return std::sqrt(value); }
		static float Tan(float value) { return std::tan(value); }										   //use in radians
